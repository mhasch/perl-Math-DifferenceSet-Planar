...
values packed in 'w*' format, calculated as differences of consecutive
...
If I<a> is an integer coprime to I<m>, and
I<D' = a E<183> D = { a E<183> d_1, ..., a E<183> d_n } (mod m)>
is also a planar difference set,  TODO
